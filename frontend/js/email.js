...
function generateTagPreview(username) {
  ...
  // supaya peluang format A vs format B kurang lebih seimbang (tidak bias
  // ke salah satu cuma karena satu array lebih panjang dari yang lain).
