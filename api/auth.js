...
export default async function handler(req, res) {
  ...
  // (fotoUrl dikecualikan: itu URL Cloudinary yang sudah kita buat sendiri di
  // server sebelumnya lewat event-upload.js, bukan input bebas dari user, dan
  // sering memicu false-positive pada filter ini)
  for (const key in req.body) {
    if (key === 'fotoUrl') continue;
