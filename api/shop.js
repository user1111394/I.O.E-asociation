...
export default async function handler(req, res) {
  ...
  if (action === 'buy-item') {
    ...
    try {
      ...
      // Catatan: penyimpanan item ke backpack member akan ditangani saat fitur
      // Backpack dibuat (fase berikutnya). Untuk saat ini transaksi koin sudah
      // tercatat dan bisa diverifikasi lewat pengurangan saldo di atas.
