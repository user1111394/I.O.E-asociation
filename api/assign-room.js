...
// Isi file ini dipisah jadi 2 bagian jelas: ROOM ASSIGN, ROOM COUNTER.
// CATATAN: fitur upload Event SEMENTARA DIPISAH KELUAR dari file ini (lihat bawah),
// karena import @vercel/blob sempat bikin seluruh file ini crash dan mematikan
// fitur assign-room/room-counter yang krusial untuk chat. Jangan gabung lagi
// ke sini sampai isu importnya benar-benar dipastikan solve di file terpisah.
...
async function assignRoom() {
  ...
  // Fill-first: isi room dengan roomId TERKECIL yang masih ada slot dulu
  // (bukan room paling sepi). Jadi room 1 diisi sampai penuh dulu, baru
  // member berikutnya mulai masuk ke room 2, dst — bukan disebar merata
  // dari awal ke semua room sekaligus.
  availableRooms.sort((a, b) => a.roomId - b.roomId);
